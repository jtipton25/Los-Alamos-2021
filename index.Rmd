...
$$
\begin{align*}
\mathbf{z} \left(t \right) - \mathbf{X} \left( t \right) \boldsymbol{\gamma} & = \mathbf{M}\left(t\right) \left( \mathbf{z} \left(t-1 \right) - \mathbf{X} \left( t \right) \boldsymbol{\gamma} \right) + \mathbf{r} \left(\mathbf{s}, \mathbf{s}^{\star} \right) \mathbf{R}^{\star}\left( \boldsymbol{\theta} \right)^{-1} \boldsymbol{\tilde{\eta}} \left(t \right).
\end{align*}
$$
...
- Talk available at [www.jtipton25.github.io/Los-Alamos-2021](https://jtipton25.github.io/Los-Alamos-2021).


## References {.smaller}
 
- <font size="2"> `r paste0(capture.output(print(biblio["banerjee2008gaussian"])), collapse = " ")` </font>
- <font size="2"> `r paste0(capture.output(print(biblio["murray2010elliptical"])), collapse = " ")` </font>
- <font size="2"> `r paste0(capture.output(print(biblio["polson2013bayesian"])), collapse = " ")` </font>
- <font size="2"> `r paste0(capture.output(print(biblio["holmstrom2015bayesian"])), collapse = " ")` </font>
- <font size="2"> `r paste0(capture.output(print(biblio["linderman2015dependent"])), collapse = " ")` </font>
- <font size="2"> `r paste0(capture.output(print(biblio["nychka2015multiresolution"])), collapse = " ")` </font>
- <font size="2"> `r paste0(capture.output(print(biblio["hefley2017basis"])), collapse = " ")` </font>
- <font size="2"> `r paste0(capture.output(print(biblio["hooten2019prior"])), collapse = " ")` </font>
- <font size="2"> `r paste0(capture.output(print(biblio["nolan2019comparing"])), collapse = " ")` </font>
- <font size="2"> `r paste0(capture.output(print(biblio["tipton2019predicting"])), collapse = " ")`</font>
